...
module.exports.homelist = function(req, res) {
    res.render('locations-list', {
        title: 'Tims Resturant - find a place to work with wifi',
        pageHeader: {
            title: '',
...
module.exports.locationInfo = function(req, res) {
    res.render('location-info', {
        ...
        sidebar: {
            context: 'is on Tims Resturant Help because it has accessible wifi and space to sit down with your laptop and get some work done.',
